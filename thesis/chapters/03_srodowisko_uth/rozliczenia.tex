...
Samo zjawisko kwalifikacji krupiera nie zmienia wyniku porównania rąk, jednakze wpływa na sposób
...
Zaprojektowałem obiekt \texttt{WagerSettlement}, który reprezentuje rozliczenie pojedynczego zakladu.
...
Łaczny wynik netto \(S_{net}\) jest sumą zysków netto wszystkich trzech zakładów, można go zapisać w postaci równania:
...
Do reprezentacji wartości finansowych uywam typu \texttt{Fraction}, poniewaz ten typo pozwala na 
przechowywanie wypłaty takiej jak \(3/2\) (bez stosowania przyblizen zmiennoprzecinkowych), w taki 
...
Zakład Blind ma stałą stawkę równą jednej jednostce Ante. W sytuacji kedy wygrywa gracz,
zysk z racji tego zakładu jest uzalezniony od tego jak wysoki uklad uda sie graczowi osiagnac.
...
wygrany zaklad Play \(4\times\), daje zysk netto równy czterem
...
Abym mógł sprawnie zmieniać warianty funkcji nagrody wykorzystywanej przez algorytmy uczenia przez wzmacnianie, 
w tym celu oddzieliłem 
mechanizm rozliczania zakładów od konstrukcji sygnału nagrody. 
Silnik domenowy
