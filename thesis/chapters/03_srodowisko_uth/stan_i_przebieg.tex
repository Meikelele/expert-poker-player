...
Tę zależność przedstawiam w tabeli~\ref{tab:karty-w-fazach}.
...
Obiekt stanu zaimplementowałem jako niemodyfikowalny, co wymusza utworzenie nowej instancji \texttt{RoundState}
