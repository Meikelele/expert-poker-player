...
W~celu
przedstawienia powtarzalności procesu treningowego obliczono dla kolejnych punktów kontrolnych
odchylenie standardowe walidacyjnego EV pomiędzy pięcioma ziarnami
wybranych konfiguracji.

Wyniki przedstawiono na rysunku~\ref{fig:seed-variability-over-training}.
...
ziarnami wybranych konfiguracji DQN i~REINFORCE. Krzywa REINFORCE
...
\begin{figure}[htbp]
    ...
    \caption{Zmienność walidacyjnego EV między ziarnami podczas
    treningu}
...
Na rysunku~\ref{fig:gradient-norm-reward-scale} porównano przebieg normy gradientu
...
logarytmicznej, norma gradientu uśredniona po pięciu ziarnach, dla DQN
