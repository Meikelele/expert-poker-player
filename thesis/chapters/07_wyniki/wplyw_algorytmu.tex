...
i~funkcji nagrody analizowany jest również główny efekt algorytmu. Porównano
REINFORCE z~DQN przy zachowaniu tej samej reprezentacji stanu, funkcji
nagrody oraz ziarna treningowego. Różnicę zdefiniowano jako
...
sparowanych ziaren (podrozdział~\ref{sec:porownania-sparowane}),
przedstawiono w~tabeli~\ref{tab:algorithm-effect}.
...
FEATURES poprawiała wyniki DQN w~sposób bardziej spójny niż wyniki
REINFORCE, więc różnica między algorytmami jest mniej widoczna właśnie
tam, gdzie DQN korzysta z~dodatkowych cech domenowych.

Te same porównania przedstawiono także na rysunku~\ref{fig:algorithm-effect}.
...
metoda lepsza pod każdym względem. Jak opisano w~
...
DQN dawała bardziej powtarzalne wyniki między ziarnami. Poza tym oba
algorytmy przyjmują nieco inny współczynnik dyskontowania, co opisano
