...
W~celu oceny wpływu sposobu reprezentacji stanu porównano warianty
RAW i~FEATURES przy zachowaniu tego samego algorytmu, funkcji nagrody
oraz ziarna treningowego. Dla każdej pary wyznaczono różnicę
...
FEATURES. Porównanie wykonano osobno dla obu algorytmów i~obu funkcji
nagrody. Jednostką porównania jest w~tym przypadku ziarno treningowe,
dlatego każda wartość średnia oraz odpowiadający jej przedział ufności
wynikają z~pięciu sparowanych różnic.

Wyniki wszystkich czterech porównań przedstawiono
...
zero, dlatego na podstawie tych pięciu par nie można wskazać wyraźnej
...
więc duże zróżnicowanie wyników między ziarnami nie pozwala uznać tego
efektu za równie stabilny jak w~przypadku DQN.

Te same porównania przedstawiono także na
...
Punkty przedstawiają średnią różnicę dla pięciu sparowanych ziaren
...
nie zaobserwowano równie stabilnego efektu zmiany reprezentacji.
